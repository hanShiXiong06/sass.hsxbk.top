  ...
  <div class="main-container">
    <el-card class="box-card !border-none" shadow="never">
      <div class="flex justify-between items-center">
        ...
        <el-button type="primary" @click="handleChange">{{ t("addRanking") }}
        </el-button>
      </div>
      ...
      <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
        <el-form :inline="true" :model="tableData.searchParam" ref="searchFormRef">
          <el-form-item :label="t('rankName')" prop="rankName">
            <el-input v-model.trim="tableData.searchParam.name" :placeholder="t('ramkkNamePlaceholder')" />
          </el-form-item>
          <el-form-item>
      ...
      <div>
        ...
        <el-table :data="tableData.data" size="large" v-loading="tableData.loading" ref="goodBamkListTableRef" @sort-change="sortChange" @selection-change="handleSelectionChange">
          <template #empty>
...
import {getRankPageList,deleteGoodRank,batchDelete,modifyGoodsRankSort} from "@/addon/shop/api/marketing";
...
const toggleChange = (value: any) => {
  ...
  goodBamkListTableRef.value.toggleAllSelection();
};

const goodBamkListTableRef = ref();
