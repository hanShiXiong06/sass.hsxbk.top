<template>
    <div class="main-container pt-[20px]" v-loading="loading">
        ...
        <el-card class="box-card !border-none" shadow="never">
            <div class="flex">
                <div class="w-[340px] h-[680px] bg-[#f6f6f6] overflow-hidden relative z-0">
                ...
                <div class="ml-[16px]">
                    <h3 class="panel-title !text-[16px]" data-v-f52cd396="">{{t('headTitle')}}</h3>
                    <el-form :model="formData" label-width="120px" ref="formRef" class="page-form">
                        <div v-for="(item,index) in formData.list" class="border-[1px] border-[#e7e7e7] border-dashed w-[500px] pt-[15px] mb-[15px] relative item" :key="index">
                            ...
                            <el-form-item :label="t('toLink')" :prop="`list.${index}.toLink.url`"  :rules="[{
                                required: true,
                                trigger: 'change',
                                validator: (rule: any, value: any, callback: any) => {
                                    if (!value) {
                                ...
                                <diy-link v-model="item.toLink"  @success="changePage"/>
                            </el-form-item>
