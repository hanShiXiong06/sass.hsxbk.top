<template>
    <div class="main-container" v-loading="loading">
		<div class="detail-head">
			...
			<span class="right"> {{ t('editGoods') }}</span>
		</div>
        <!-- 表单 -->
			...
			<el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form">
                <el-card class="box-card !border-none" shadow="never">
                    ...
                    <!-- <el-form-item :label="t('goodsType')" prop="active_name">
                        <div class="goods-type-wrap flex flex-col items-center justify-center" :class="[formData.type == item.type ? 'selected' : 'disabled']" v-for="(item) in goodsType" :key="item.type">
                    ...
                    <template v-if="formData.type=='coupon'">
                        <el-form-item :label="t('couponSelect')">
                            <div class="w-full">
                                <el-table v-if="formData.product_list.length" class="!max-w-[100%]" :data="formData.product_list" size="large">
                                    <template #empty>
                                    ...
                                    <el-table-column  :label="t('sumCount')" min-width="140">
                                        <template #default="{ row }">
                                            <span v-if="row.remain_count != '-1'">{{ row.remain_count || '' }}</span>
