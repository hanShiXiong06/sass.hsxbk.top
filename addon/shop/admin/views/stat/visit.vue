<template>
    <div class="min-w-[100px] min-h-[650px] p-[15px] bg-white statIndex mb-[150px]">
        ...
        <div class="w-[1586px] h-[120px] bg-[#f3f8ff] mt-[15px] flex">
        ...
        <div class="w-[1586px] h-[120px] bg-[#fffaf3] mt-[15px] flex">
