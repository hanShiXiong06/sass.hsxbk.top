        ...
        $search_model = $this->model
            ...
            ->with([
                'order_goods' => function($query) {
                    $query->field('extend,order_goods_id, order_id, member_id, goods_id, sku_id, goods_name, sku_name, goods_image, sku_image, price, num, goods_money, is_enable_refund, goods_type, delivery_status, status,discount_money,site_id,delivery_id')->append([ 'delivery_status_name', 'status_name', 'goods_image_thumb_small' ]);
                }
