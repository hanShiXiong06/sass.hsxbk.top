    ...
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateLog') : t('addLog')" width="50%" class="diy-dialog-wrap" :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form" v-loading="loading">
                ...
                <el-form-item :label="t('overTime')" >
                    <el-input v-model="formData.over_time" clearable :placeholder="t('overTimePlaceholder')" class="input-width" />
                </el-form-item>
...
import { addLog, editLog, getLogInfo, getWithMemberList, getWithMemberLevelList } from '@/addon/tk_vip/api/log'
