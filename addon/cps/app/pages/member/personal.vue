    ...
    <view class="w-full h-screen bg-page" v-if="info">
        ...
        <view class="m-[30rpx] bg-white rounded-md overflow-hidden px-[20rpx] py-[10rpx]">
            <u-cell-group :border="false">
                ...
                <u-cell title="城市" :is-link="true" value="上海"></u-cell>
            </u-cell-group>
        </view>
        <view class="m-[30rpx] bg-white rounded-md overflow-hidden px-[20rpx] py-[10rpx]">
            <u-cell-group :border="false">
                ...
                <u-cell title="简介" :is-link="true" value="拯救地球好累"></u-cell>
            </u-cell-group>
        </view>
        <view class="m-[30rpx] bg-white rounded-md overflow-hidden px-[20rpx] py-[10rpx]">
            <u-cell-group :border="false">
                <u-cell title="用户协议" :is-link="true" value=""></u-cell>
                <u-cell title="隐私政策" :is-link="true" value=""></u-cell>
                <u-cell title="关于我们" :is-link="true" value=""></u-cell>
            </u-cell-group>
        </view>
