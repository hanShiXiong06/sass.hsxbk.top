    ...
    >
      <el-card class="box-card !border-none" shadow="never">
        <div style="width: 520px">
          <el-alert
            type="warning"
            title="本存储需使用123盘直链功能，会员/超级会员才可使用，直链流量50元/T"
            :closable="false"
            show-icon
          />
        </div>
        ...
        <el-form-item label="上传目录" prop="dir">
          <el-input
            ...
            placeholder="如oss,根目录下需要不存在这个目录"
            class="input-width"
            clearable
          />
        </el-form-item>
        ...
        <el-form-item label="快速导航">
          <el-button>
            <a href="https://www.123pan.com/s/Ggx9-gAmJv.html" target="_blank"
              >123网盘注册</a
            >
          </el-button>

          <el-button>
            <a href="https://www.123pan.com/developer" target="_blank"
              >开放平台申请</a
            >
          </el-button>
