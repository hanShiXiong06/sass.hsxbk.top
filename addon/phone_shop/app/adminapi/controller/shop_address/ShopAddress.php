...
namespace addon\phone_shop\app\adminapi\controller\shop_address;

use core\base\BaseAdminController;
use addon\phone_shop\app\service\admin\shop_address\ShopAddressService;


/**
 * 商家地址库控制器
 * Class ShopAddress
 * @package addon\phone_shop\app\adminapi\controller\shop_address
 */
class ShopAddress extends BaseAdminController
{
    ...
    */
    ...
    public function add(){
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\shop_address\ShopAddress.add');
    ...
    public function edit($id){
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\shop_address\ShopAddress.edit');
