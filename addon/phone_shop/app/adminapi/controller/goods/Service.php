...
use addon\phone_shop\app\service\admin\goods\ServiceService;
...
class Service extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\goods\Service.add');
    ...
    public function edit($id)
    {
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\goods\Service.edit');
