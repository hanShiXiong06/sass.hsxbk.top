...
use addon\phone_shop\app\service\admin\goods\AttrService;
...
class Attr extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\goods\Attr.add');
    ...
    public function edit(int $id)
    {
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\goods\Attr.edit');
