...
use addon\phone_shop\app\service\admin\goods\LabelGroupService;
...
class LabelGroup extends BaseAdminController
{
    ...
    public function add()
    {
       ...
       //  $this->validate($data, 'addon\phone_shop\app\validate\goods\LabelGroup.add');
    ...
    public function edit($id)
    {
        ...
        // $this->validate($data, 'addon\phone_shop\app\validate\goods\LabelGroup.edit');
