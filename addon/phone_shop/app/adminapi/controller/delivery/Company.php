...
use addon\phone_shop\app\service\admin\delivery\CompanyService;
...
class Company extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\delivery\Company.add');
    ...
    public function edit($id)
    {
        ...
        $this->validate($data, 'addon\phone_shop\app\validate\delivery\Company.edit');
