...
return [
    'shop_buy_goods' => [
        'key' => 'phone_shop_buy_goods',
        'name' => '购买商品',
        'desc' => '订单交易成功后按订单交易金额发放成长值',
        'component' => '/src/addon/phone_shop/views/member/components/growth-rule-buygoods.vue',
        ...
        'content' => [
            ...
            'task' => function($site_id, $config) {
                return [
                    'icon' => '/addon/phone_shop/rule/growth-rule-cart.png',
                    'title' => '购买商品',
                    'desc' => "购买商品可获得{$config['growth']}成长值/{$config['money']}元",
                    'button' => [
                        'text' => '去购买',
                        'wap_redirect' => '/addon/phone_shop/pages/index'
                    ]
                ];
            }
        ]
    ...
    'shop_buy_order' => [
        'key' => 'phone_shop_buy_order',
        'name' => '完成下单',
        'desc' => '订单交易成功后发放成长值',
        'component' => '/src/addon/phone_shop/views/member/components/growth-rule-buyorder.vue',
        ...
        'content' => [
            ...
            'task' => function($site_id, $config) {
                return [
                    'icon' => '/addon/phone_shop/rule/growth-rule-buy.png',
                    'title' => '完成下单',
