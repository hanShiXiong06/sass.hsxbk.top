...
class GoodsService extends BaseAdminService
{
    ...
    public function add(array $data)
    {
        try {
            ...
            //         'is_default' => 1
            //     ];
            //     // 如果 站点的id == 100005 那么 需要 将 member_price 里 设置我 {"level_1":price}
            //     if ($this->site_id == 100005) {
            //         $sku_data[ 'member_price' ] = json_encode([ 'level_1' => $data[ 'price' ] ]);
            //         // 并且 判断 price的价格 如果是低于1000 则 将其加 100 给 price
            //          // 如果 判断 price的价格 如果是低于5000 则 将其加 200 给 price
            //           // 如果 判断 price的价格 如果是低于5000 则 将其加 300 给 price
            //           if ($data[ 'price' ] < 1000) {
            ...
            //         ];
            //         if ($this->site_id == 100005) {
            //             $sku_data[ 'member_price' ] = json_encode([ 'level_1' => $v[ 'price' ] ]);
            //             // 并且 判断 price的价格 如果是低于1000 则 将其加 100 给 price
            //              // 如果 判断 price的价格 如果是低于5000 则 将其加 200 给 price
            //               // 如果 判断 price的价格 如果是低于5000 则 将其加 300 给 price
            //               if ($data[ 'price' ] < 1000) {
            //                 $sku_data[ 'price' ] = $v[ 'price' ] + 100;
            //             } elseif ($data[ 'price' ] < 5000) {
            //                 $sku_data[ 'price' ] = $v[ 'price' ] + 200;
            //             } else {
            //                 $sku_data[ 'price' ] = $v[ 'price' ] + 300;
            //             }
            //         }
