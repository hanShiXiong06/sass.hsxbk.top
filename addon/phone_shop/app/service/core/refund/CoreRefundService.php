...
namespace addon\phone_shop\app\service\core\refund;
...
class CoreRefundService extends BaseCoreService
{
    ...
    public function finish($data)
    {
        ...
        $normal_goods_count = (new OrderGoods())->where([
            ['order_id', '=', $order_id],
            ['status', '=', 'normal']
        ])->count();
