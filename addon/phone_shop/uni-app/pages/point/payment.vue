                            ...
                            <view v-if="!$u.test.isEmpty(orderData.delivery.take_address)" class="py-[30rpx]">
                                <view class="flex items-center">
                                    ...
                                    <view class="flex flex-col">
                                        <text
                                            class="text-[22rpx] text-[#999] truncate max-w-[536rpx]">{{ orderData.delivery.take_address.full_address.split(orderData.delivery.take_address.address)[0] }}</text>
                                        <text
                                            class="text-[32rpx] text-[#303133] mt-[16rpx] truncate max-w-[536rpx]">{{ orderData.delivery.take_address.address }}</text>
                                    </view>
                ...
                <view class="mb-[20rpx] p-[30rpx] rounded-[16rpx] bg-white">
                    <view class="mb-[30rpx]">
                        <view class="flex" v-for="(item, key, index) in orderData.goods_data" :key="index"
                            ...
                            <u--image class="rounded-[10rpx] overflow-hidden" width="170rpx" height="170rpx"
                                :src="img(item.sku_image.split(',')[0])" model="aspectFill">
                                <template #error>
                    ...
                    <view class="flex items-center mt-[25rpx] text-[#303133]">
                        ...
                        <view class="flex-1 w-0 text-right  price-font">
                            ...
                            <block v-if="orderData.basic && parseFloat(orderData.basic.goods_money)">
                                ...
                                <text class="text-[32rpx]">.{{
                                    parseFloat(orderData.basic.goods_money).toFixed(2).split('.')[1]
                                    }}</text>
                            </block>
                        </view>
                    </view>
            ...
            <u-tabbar :fixed="true" :placeholder="true" :safeAreaInsetBottom="true">
                <view class="flex-1 flex items-center justify-between">
                    <view class="whitespace-nowrap px-[30rpx]">
                        ...
                        <text
                            class="text-[32rpx]  font-500  text-[var(--price-text-color)] price-font leading-[32rpx]">{{
                            orderData.basic.point_sum }}积分</text>
                        <block v-if="orderData.basic && parseFloat(orderData.basic.goods_money)">
                            <text
                                class="text-[28rpx]  font-500  text-[var(--price-text-color)] price-font leading-[46rpx] mx-[4rpx]">+</text>
                            <text
                                class="text-[32rpx] font-500 text-[var(--price-text-color)] price-font leading-[31rpx]">￥</text>
                            <text
                                class="text-[32rpx] font-500 text-[var(--price-text-color)] price-font leading-[32rpx]">{{
