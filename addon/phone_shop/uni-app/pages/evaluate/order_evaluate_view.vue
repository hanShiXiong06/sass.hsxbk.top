                ...
                <template v-for="(item, index)  in info" :key="index">
                    <view class="bg-white py-[20rpx] px-[24rpx] mb-[20rpx] rounded-[16rpx]">
                        <view class="flex mb-[20rpx]"
                            @click="redirect({ url: '/addon/phone_shop/pages/goods/detail', param: { goods_id: item.goods_id } })">
                        ...
                        <view
                            ...
                            <u-rate :count="5" v-model="item.scores" active-color="var(--primary-color)" :size="'32rpx'"
                                readonly></u-rate>
                            <text class="ml-[20rpx] text-[26rpx] text-[#888]">{{ item.scores === 1 ? '差评' : item.scores
                                === 2 || item.scores ===
                                3 ? '中评' : '好评' }}</text>
                        </view>
                            ...
                            <view class="flex justify-between mt-[10rpx]">
                                ...
                                <view>
                                    ...
                                    <u--image class="rounded-[8rpx] overflow-hidden" width="205rpx" height="205rpx"
                                        ...
                                        @click="imgListPreview(item.images[2])">
                                        <template #error>
                                            <u-icon name="photo" color="#999" size="50"></u-icon>
                                        </template>
                                    </u--image>
                        ...
                        <template v-if="item.image_mid.length === 4">
                            <view class="flex flex-wrap mt-[10rpx]">
                                ...
                                <u--image class="rounded-[8rpx] overflow-hidden mr-[15rpx]" width="215rpx"
                                    height="215rpx" :src="img(item.image_mid[2])" model="aspectFill"
                                    @click="imgListPreview(item.images[2])">
                                    <template #error>
                                        <u-icon name="photo" color="#999" size="50"></u-icon>
                                    </template>
                                ...
                                <u--image class="rounded-[8rpx] overflow-hidden mr-[15rpx]" width="215rpx"
                                    height="215rpx" :src="img(item.image_mid[3])" model="aspectFill"
                                    @click="imgListPreview(item.images[3])">
                                    <template #error>
                                        <u-icon name="photo" color="#999" size="50"></u-icon>
                                    </template>
                                </u--image>
                        ...
                        <view v-if="item.explain_first != ''"
                            class="text-[26rpx] !text-[#666] mt-[20rpx] pt-[20rpx] border-0 border-t-[2rpx] border-solid border-[#ebebec] w-[100%] overflow-clip leading-[1.2] break-all">
