        ...
        <view @touchmove.prevent.stop>
            ...
            <view class="border-0 !border-b !border-[#eee] border-solid" v-if="!type">
                <u-tabs :list="tabs" @click="switchTab" :current="current"
                    itemStyle="width:50%;height:88rpx;box-sizing: border-box;"
            ...
            <scroll-view scroll-y="true" class="h-[50vh]">
                <view class="p-[30rpx] pt-0 text-sm" v-show="current == 0">
                    <view class="mt-[30rpx] px-[30rpx] py-[20rpx] border-1 !border-[#eee] border-solid rounded-[20rpx]"
                        ...
                        <view class="flex border-0 !border-b !border-[#eee] border-dashed pb-[20rpx]"
                            :class="{ '!border-primary': coupon && coupon.id == item.id }">
                            ...
                            <view class="font-bold text-base price-font"><text class="text-xs">￥</text>{{ item.price }}
                            </view>
                        </view>
                ...
                <view class="p-[30rpx] pt-0 text-sm" v-show="current == 1">
                    <view
                        class="mt-[30rpx] px-[30rpx] py-[20rpx] border-1 !border-[#eee] border-solid rounded-[20rpx] bg-[#f5f5f5]"
