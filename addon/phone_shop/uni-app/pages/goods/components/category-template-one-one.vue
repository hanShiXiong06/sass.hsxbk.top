	...
	<view class="min-h-screen">
		<view class="mescroll-box bg-[#F4F6F8]"
			...
			<mescroll-body ref="mescrollRef" :down="{ use: false }" @init="mescrollInit" @up="getListFn">
				...
				<!--  #endif -->
				<view class="flex justify-center flex-wrap pl-[182rpx] pb-[20rpx]"
					:class="{ ' pt-[126rpx]': config.search.control, ' pt-[20rpx]': !(config.search.control) }">
					<template v-for="(item, index) in list" :key="item.goods_id">
						<view
							...
							<view class="mr-[8rpx]">
								<u--image width="168rpx" height="168rpx" radius="12rpx"
									:src="img(item.goods_cover_thumb_mid ? item.goods_cover_thumb_mid : '')"
									model="aspectFill">
									<template #error>
										<image class="rounded-[12rpx] overflow-hidden w-[168rpx] h-[168rpx]"
					...
					<view class="mx-[24rpx]  w-[536rpx] rounded-[12rpx] flex items-center justify-center"
