        ...
        <view class="overflow-hidden" :style="warpCss">
            ...
            <view class="diy-shop-exchange-goods-list relative flex flex-wrap justify-between">
                <view class="overflow-hidden bg-[#fff] flex flex-col box-border w-[calc(50%-10rpx)]"
                    ...
                    <u--image :width="style2Width" :height="style2Width" :src="img(item.goods_cover_thumb_mid || '')"
                        model="aspectFill">
                        <template #error>
                    ...
                    <view class="flex-1 pt-[10rpx] pb-[20rpx] px-[16rpx] flex flex-col justify-between">
                        <view class="text-[#333] leading-[40rpx] text-[28rpx] multi-hidden"
                        ...
                        <view class="text-[24rpx] font-400 leading-[34rpx] mt-[10rpx] text-[#999]"
                            :style="{ color: diyComponent.saleStyle.color }">已兑{{ item.total_exchange_num }}人</view>
                        <view class="flex justify-between flex-wrap items-center mt-[16rpx]">
                            <view class="flex flex-col">
                                <view :style="{ color: diyComponent.priceStyle.mainColor }"
                                    class="text-[var(--price-text-color)] price-font ml-[2rpx] flex items-center">
                                ...
                                <view v-if="item.price && item.price > 0" class="flex items-center mt-[6rpx]">
                                    <text :style="{ color: diyComponent.priceStyle.mainColor }"
                                        class="text-[#333] font-400 text-[24rpx]">+{{ parseFloat(item.price).toFixed(2)
                                        }}</text>
                                    <text :style="{ color: diyComponent.priceStyle.mainColor }"
                                        class="text-[var(--price-text-color)] font-400 ml-[4rpx] text-[20rpx]">元</text>
                                </view>
                            </view>
                            <view
                                class="w-[80rpx] h-[46rpx] font-400 text-[28rpx] leading-[46rpx] !text-[#fff] m-0 rounded-full !bg-[var(--primary-color)] remove-border text-center"
