<template>
    <view :style="warpCss">
        ...
        <view class="diy-shop-search relative overflow-hidden flex items-center pl-[24rpx]">
            <image :src="img('addon/phone_shop/diy/search_01.png')" class="w-[40rpx] h-[40rpx]" mode="widthFix"
                @click="toLink('/addon/phone_shop/pages/goods/category')"></image>
            <view
                class="flex-1 ml-[24rpx] rounded-[32rpx] flex items-center bg-[#F7F8FD] opacity-90 py-[10rpx] pl-[38rpx] pr-[32rpx] justify-between"
                @click="toLink('/addon/phone_shop/pages/goods/search')">
