<template>
    <el-dialog v-model="showDialog" :title="t('refundTitle')" width="800px" class="diy-dialog-wrap"
            ...
            <el-form :model="formData" label-width="100px" ref="formRef" :rules="formRules" class="page-form mb-[30px]">
                <el-form-item :label="t('refundMoney')">
                    <div class="text-[red]">
                        ...
                        <span v-if="isShowDelivery"
                            class="text-[#999] text-[24rpx]">（运费:￥{{ formData.delivery_money }}）</span>
                    </div>
                </el-form-item>
                <el-form-item :label="t('refundGoodsItem')">
                    <el-table :data="refundTable" size="large" ref="refundTableRef" @select="refundSelectChange"
                        @select-all="refundSelectAll">
                ...
                <el-form-item :label="t('refundInstructions')" prop="shop_active_refund_remark">
                    <el-input v-model.trim="formData.shop_active_refund_remark" :rows="5" type="textarea"
