						...
						<div class="flex items-center justify-between">
							...
							<div>
								<template v-if="item.key === 'local_delivery'">
									<el-button type="primary" link @click="goRouter('/phone_shop/order/delivery/staff')">{{ t('deliveryStaff') }}</el-button>
									<el-button type="primary" link @click="goRouter('/phone_shop/order/delivery/local')">{{ t('localConfig') }}</el-button>
								</template>
								<template v-if="item.key === 'express'">
									<el-button type="primary" link @click="goRouter('/phone_shop/order/delivery/company')">{{ t('deliveryCompany') }}</el-button>
									<el-button type="primary" link @click="goRouter('/phone_shop/order/shipping/template')">{{ t('deliveryTemplate') }}</el-button>
									<el-button type="primary" link @click="goRouter('/phone_shop/order/delivery/search')">{{ t('deliverySearch') }}</el-button>
								</template>
								<template v-if="item.key === 'store'">
									<el-button type="primary" link @click="goRouter('/phone_shop/order/delivery/store')">{{ t('deliveryStore') }}</el-button>
								</template>
							</div>
						</div>
					</el-card>
