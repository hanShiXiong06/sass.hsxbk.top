                ...
                <el-form-item :label="t('deliveryAddress')" prop="delivery_address">
                    <div class="flex flex-col">
                        <div class="flex">
                            ...
                            <el-button type="primary" @click="router.push('/phone_shop/order/address')" link class="ml-[10px]">{{ defaultDeliveryAddress ? t('update') : t('toSetting') }}</el-button>
                        </div>
...
import { setLocal, getLocal } from '@/addon/phone_shop/api/delivery'
import { FormInstance } from 'element-plus'
import Test from '@/utils/test'
import { getShopDefaultDeliveryAddressInfo } from '@/addon/phone_shop/api/shop_address'
...
const back = () => {
    router.push({ path: '/phone_shop/order/delivery' })
}
</script>
