        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="goodsAttrTable.searchParam" ref="searchFormRef">
                    <el-form-item :label="t('attrName')" prop="attr_name">
                        <el-input v-model="goodsAttrTable.searchParam.attr_name"
            ...
            <div class="mt-[10px]">
                <el-table :data="goodsAttrTable.data" size="large" v-loading="goodsAttrTable.loading"
                    ...
                    <el-table-column prop="attr_name" :label="t('attrName')" min-width="320"
                        :show-overflow-tooltip="true" />

                    <el-table-column prop="sort" :label="t('sort')" min-width="120" sortable="custom">
                        <template #default="{ row }">
                            <el-input v-model="row.sort" class="!w-[100px]" maxlength="8"
                    ...
                    <el-table-column :label="t('operation')" fixed="right" align="right" min-width="120">
                        <template #default="{ row }">
                            <div v-if="userStore().siteInfo.site_id == row.site_id" >
                                <el-button type="primary"  link
                                    @click="manageEvent(row)">{{ t('manage') }}</el-button>
                                <el-button type="primary" link @click="editEvent(row)">{{ t('edit') }}</el-button>
                                <el-button type="primary" link @click="deleteEvent(row.attr_id)">{{ t('delete')
                                    }}</el-button>
                            </div>
                        </template>
                    </el-table-column>
