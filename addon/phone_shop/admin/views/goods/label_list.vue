                    ...
                    <el-table-column :label="t('operation')" fixed="right" align="right" min-width="120">
                        <template #default="{ row }">
                            <div v-if="userStore().siteInfo.site_id == row.site_id">
                                ...
                                <el-button type="primary" link @click="deleteEvent(row.label_id)">{{ t('delete')
                                    }}</el-button>
                            </div>
                        </template>
                    </el-table-column>
...
import { t } from '@/lang'
import { getLabelPageList, deleteLabel, modifyLabelSort } from '@/addon/phone_shop/api/goods'
