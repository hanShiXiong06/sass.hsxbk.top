...
import { getActiveDiscountPageList,getActiveDiscountStatusList,closeActiveDiscount,deleteActiveDiscount } from "@/addon/phone_shop/api/marketing";
import { t } from '@/lang'
...
const detailEvent=(id:number)=>{
    router.push({path:'/phone_shop/marketing/discount/detail',query:{id}})
}
//编辑折扣券
