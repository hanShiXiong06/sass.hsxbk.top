...
export function addCoupon(params: Record<string, any>) {
  return request.post(`phone_shop/goods/coupon`, params, {
...
export function editCouponStatus(params: Record<string, any>) {
  return request.put(
    `phone_shop/goods/coupon/setstatus/${params.status}`,
    params,
    { showSuccessMessage: true }
  );
}
...
export function deleteCoupon(id: number) {
  return request.delete(`phone_shop/goods/coupon/${id}`, {
    showSuccessMessage: true,
  });
}
...
export function closeCoupon(id: number) {
  return request.put(`phone_shop/goods/coupon/invalid/${id}`, {
    showSuccessMessage: true,
  });
}
...
export function addActiveDiscount(params: Record<string, any>) {
  return request.post("phone_shop/active/discount", params, {
    showErrorMessage: true,
    showSuccessMessage: true,
  });
}
...
export function editActiveDiscount(params: Record<string, any>) {
  return request.put(`phone_shop/active/discount/${params.active_id}`, params, {
    showErrorMessage: true,
    showSuccessMessage: true,
  });
}
...
export function closeActiveDiscount(active_id: number) {
  return request.put(
    `phone_shop/active/discount/close/${active_id}`,
    {},
    {
      showErrorMessage: true,
      showSuccessMessage: true,
...
export function deleteActiveDiscount(active_id: number) {
  return request.delete(`phone_shop/active/discount/${active_id}`, {
    showSuccessMessage: true,
  });
}
...
export function getActiveDiscountGoodsPageList(params: Record<string, any>) {
  return request.get(`phone_shop/active/discount/goods/${params.active_id}`, {
    params,
  });
}
...
export function getActiveDiscountOrderPageList(params: Record<string, any>) {
  return request.get(`phone_shop/active/discount/order/${params.active_id}`, {
    params,
  });
}
...
export function getActiveDiscountMemberPageList(params: Record<string, any>) {
  return request.get(`phone_shop/active/discount/member/${params.active_id}`, {
    params,
  });
}
...
export function addActiveExchange(params: Record<string, any>) {
  return request.post("phone_shop/active/exchange", params, {
    showErrorMessage: true,
    showSuccessMessage: true,
  });
}
...
export function deleteActiveExchange(id: number) {
  return request.delete(`phone_shop/active/exchange/${id}`, {
    showSuccessMessage: true,
  });
}
