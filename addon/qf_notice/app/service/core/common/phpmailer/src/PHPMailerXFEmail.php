...
namespace addon\qf_notice\app\service\core\common\phpmailer\src;
...

{
    ...
    protected function addOrEnqueueAnAddress($kind, $address, $name)
    {
        ...
        if (false === $pos) {
            ...
            if ($this->exceptions) {
                throw new ExceptionXFEmail($error_message);
            }
