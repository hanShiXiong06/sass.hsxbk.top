 ...
 */
class LicenseNotInstalledException extends GeneralException {
    const ErrCode = 2000;
    
    public function __construct($message = "LicenseNotInstalledException", $code = self::ErrCode, Throwable $previous = NULL) {
