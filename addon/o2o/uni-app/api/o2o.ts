...
export function TransferOrder(params: Record<string, any>) {
    return request.post(`o2o/technician/order/transfer`, params, { showErrorMessage: true, showSuccessMessage: true })
}
...
export function beginService(params: Record<string, any>) {
    return request.post(`o2o/technician/order/service`, params, { showErrorMessage: true, showSuccessMessage: true })
}
...
export function finishService(params: Record<string, any>) {
    return request.post(`o2o/technician/order/finish`, params, { showErrorMessage: true, showSuccessMessage: true })
}
