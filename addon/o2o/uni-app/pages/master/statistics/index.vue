            ...
            <view class="bg-[#fff] min-h-screen box-border overflow-hidden" v-if="Object.keys(technicianStat).length && Object.keys(technicianInfo).length">
                <view class=" h-[552rpx] px-[30rpx] pt-[114rpx] box-border" :style="{'background-image':'url(' + img('addon/o2o/technician/bg.png') + ')','background-size':'100%'}">
                    <view class="flex items-center">
                        <u--image width="120rpx" height="120rpx" :src="img(technicianInfo.headimg ? technicianInfo.headimg : '')" model="aspectFill" shape="circle" class="border-[#fff] border-[4rpx] border-solid rounded-full " >
                            <template #error>
                ...
                <view class="p-[20rpx] bg-[#fff] mx-[30rpx] mt-[-150rpx] rounded-[10rpx]">
                    ...
                    <view class="flex flex-wrap justify-between" >
                        <view class="p-[20rpx] w-[315rpx] box-border mb-[20rpx]" :style="{'background-image':'url(' + img('addon/o2o/technician/waitservice.png') + ')','background-size':'100%'}" @click="redirect({url:'/addon/o2o/pages/master/task/list',param:{order_status : 'wait_service'}})">
                        ...
                        <view class="p-[20rpx] w-[315rpx] box-border mb-[20rpx]" :style="{'background-image':'url(' + img('addon/o2o/technician/inservice.png') + ')','background-size':'100%'}" @click="redirect({url:'/addon/o2o/pages/master/task/list',param:{order_status : 'in_service'}})">
                        ...
                        <view class="p-[20rpx] w-[315rpx] box-border" :style="{'background-image':'url(' + img('addon/o2o/technician/finish.png') + ')','background-size':'100%'}" @click="redirect({url:'/addon/o2o/pages/master/task/list',param:{order_status : 'finish'}})">
                        ...
                        <view class="p-[20rpx] w-[315rpx] box-border" :style="{'background-image':'url(' + img('addon/o2o/technician/serviceitem.png') + ')','background-size':'100%'}" @click="redirect({url:'/addon/o2o/pages/technician/detail',param:{id : technicianInfo.id}})">
