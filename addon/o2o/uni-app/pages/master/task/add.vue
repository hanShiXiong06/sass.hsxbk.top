	...
	<view class="bg-[#F5F6FA] min-h-screen overflow-hidden" :style="themeColor()">
		<view class="mx-[30rpx] my-[20rpx] bg-[#fff] rounded-[16rpx]">
			<view class="text-[34rpx] p-[36rpx] border">
				{{ formData.order_item_id ? t('editServiceItem') : t('addServiceItem')  }}
			</view>
			<u-form labelPosition="left" :model="formData" errorType='toast' :rules="formRules" ref="serviceRef" :labelWidth="100" class="px-[30rpx]" :labelStyle="{paddingLeft:'30rpx',fontSize:'28rpx'}" >
				...
				<u-form-item :label="t('serviceImg')" prop="images" class="form-images">
					<view class="px-[30rpx]">
						<upload-img class="mt-[20rpx]" v-model="formData.images" :max-count="6" :multiple="false"/>
					</view>
				</u-form-item>
