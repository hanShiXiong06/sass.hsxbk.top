<template>
    <view class="bg-[#f8f8f8] min-h-screen overflow-hidden" v-if="detail" :style="themeColor()">
        ...
        <view class="bg-page">
            ...
            <view class="m-[24rpx] px-[24rpx] rounded-md bg-white">
                <view class="py-[24rpx]">
                    <view class="text-sm">{{ t('description') }}<text class="text-xs text-gray-subtitle ml-[10rpx]">{{ t('optional') }}</text></view>
                    <view class="p-[20rpx] bg-[#f5f5f5] rounded mt-[20rpx] h-[300rpx] relative">
                        ...
                        <view class="absolute bottom-[20rpx] right-[20rpx]  text-[24rpx] text-[#808080]">{{ Number(formData.remark.length) >= 100 ? 100 : formData.remark.length }}/100</view>
                    </view>
                </view>
            </view>
                ...
                <view class="px-[30rpx] pb-[30rpx]">
                    ...
                    <scroll-view scroll-y="true" class="h-[450rpx] mt-[20rpx]">
						<u-radio-group v-model="currReasonName" placement="column" activeColor="var(--primary-color)">
							<u-radio :customStyle="{marginBottom: '8px'}" v-for="(item, index) in reason" :key="index" :label="item" :name="item">
							</u-radio>
						</u-radio-group>
					</scroll-view>
