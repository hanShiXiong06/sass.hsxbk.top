								...
								<el-col :span="8">
									<div class="w-full py-[16px] px-[20px] border-[#E6E6E6] border-[1px]">
										<div class="flex items-center">
											...
											<el-tooltip class="box-item" effect="light" :content="t('totalRevenueTips')" placement="top">
												<el-icon>
													<QuestionFilled/>
												</el-icon>
											</el-tooltip>
								...
								<el-col :span="8">
									<div class="w-full py-[16px] px-[20px] border-[#E6E6E6] border-[1px]">
										<div class="flex items-center">
											...
											<el-tooltip class="box-item" effect="light" :content="t('orderItemPayTips')" placement="top">
												<el-icon>
													<QuestionFilled/>
												</el-icon>
											</el-tooltip>
...
const defaultValue = {
    ...
    refund_num: '0',
    item_order_num: '0',
    item_order_money: '0.00'
}
const loading = ref(false)
const statYesterday = ref(defaultValue)
const statToday = ref(defaultValue)
const statMonth = ref(defaultValue)
const statTotal = ref(defaultValue)
