...
class RefundDict
{
    ...
    public static function getRefundStatus(string $status = '')
    {
        $data = [
            self::WAIT_REFUND => [
                'name' => get_lang('dict_tourism_order_refund.wait_refund'),
                'status' => self::WAIT_REFUND
            ],
            self::REFUNDING => [
                'name' => get_lang('dict_tourism_order_refund.refunding'),
                'status' => self::REFUNDING
            ],
            self::REFUND_COMPLETED => [
                'name' => get_lang('dict_tourism_order_refund.refund_completed'),
                'status' => self::REFUND_COMPLETED
            ],
            self::REFUND_REFUSE => [
                'name' => get_lang('dict_tourism_order_refund.refund_refuse'),
                'status' => self::REFUND_REFUSE
            ],
            self::REFUND_FAIL => [
                'name' => get_lang('dict_tourism_order_refund.refund_fail'),
                'status' => self::REFUND_FAIL
            ],
            self::CANCEL => [
                'name' => get_lang('dict_tourism_order_refund.cancel'),
                'status' => self::CANCEL
            ]
        ];
