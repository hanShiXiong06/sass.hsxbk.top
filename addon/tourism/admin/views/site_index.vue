		...
		<div class="main-body flex-1 mr-[15px]" v-if="!loading">
			<el-card class="box-card !border-none" shadow="never">
				<div class="flex items-end">
					...
					<div class="bg-primary h-[45px] flex items-center px-[20px] rounded-r-lg ml-[10px] text-[#fff] cursor-pointer"
						@click="handelVerify">
						<span>{{ t('write') }}</span>
					</div>
					<span class="text-primary text-[14px] ml-[20px] cursor-pointer"
						@click="toLink('/order/tourism/verify')">{{ t('viewWrite') }}</span>
				</div>

				<el-row class="mt-[40px]" justify="space-between">
					<el-col :span="5">
						<div class="w-[163px] 2xl:w-[200px] rounded-[10px] overflow-hidden bg-[#646DFF] flex flex-wrap cursor-pointer"
							@click="toLink('/tourism/hotel/hotel')">
							...
							<div
								class="manage-item h-[30px] w-full flex justify-between items-center text-[10px] text-[#fff]">
					...
					<el-col :span="5">
						<div class="w-[163px] 2xl:w-[200px] rounded-[10px] overflow-hidden bg-[#F7B500] flex flex-wrap cursor-pointer"
							@click="toLink('/tourism/scenic/scenic')">
							<div class="w-full py-[21px] flex items-center text-[#fff] pl-[20px] ">
					...
					<el-col :span="5">
						<div class="w-[163px] 2xl:w-[200px] rounded-[10px] overflow-hidden bg-[#03C1A5] flex flex-wrap cursor-pointer"
							@click="toLink('/tourism/way/way')">
							<div class="w-full py-[21px] flex items-center text-[#fff] pl-[20px] ">
					...
					<el-col :span="5">
						<div class="w-[163px] 2xl:w-[200px] rounded-[10px] overflow-hidden bg-[#FF7387] flex flex-wrap cursor-pointer"
							@click="toLink('/order/tourism/verify')">
							<div class="w-full py-[21px] flex items-center text-[#fff] pl-[20px] ">
					...
					<el-row justify="space-between">
						<el-col :span="5">
							...
							<div class="statistic-footer flex justify-between items-end mt-[10px]">
								...
								<div @click="toLink('/order/tourism/hotel')"
									class="flex items-center cursor-pointer justify-center border-[1px] border-primary text-[12px] text-primary w-[70px] h-[30px] rounded-[3px]">
									<span>
										{{ t('detailData') }}
									</span>
								</div>
							...
							<div class="statistic-footer flex justify-between items-end mt-[10px]">
								<div>
									...
									<div class="footer-item text-[14px] text-[#666]">
										<span>{{ t('yesterdayOrderNum') }}：</span>
										<span class="green ml-1">
											+ {{ statYesterdayInfo.scenic_order_money }}
										</span>
										<span></span>
									</div>
								</div>
								<div @click="toLink('/order/tourism/scenic')"
									class="flex items-center cursor-pointer justify-center border-[1px] border-primary text-[12px] text-primary w-[70px] h-[30px] rounded-[3px]">
									<span>
										{{ t('detailData') }}
									</span>
						...
						<el-col :span="5">
							...
							<div class="statistic-footer flex justify-between items-end mt-[10px]">
								...
								<div @click="toLink('/order/tourism/way')"
									class="flex items-center cursor-pointer justify-center border-[1px] border-primary text-[12px] text-primary w-[70px] h-[30px] rounded-[3px]">
									<span>
										{{ t('detailData') }}
									</span>
							...
							<div class="statistic-footer flex justify-between items-end mt-[10px]">
								<div>
									...
									<div class="footer-item text-[14px] text-[#666]">
										<span>{{ t('yesterdayOrderNum') }}：</span>
										<span class="green ml-1">
											+ {{ statYesterdayInfo.refund_money }}
										</span>
										<span></span>
									</div>
								</div>
								<div @click="toLink('/order/tourism/refund')"
									class="flex items-center cursor-pointer justify-center border-[1px] border-primary text-[12px] text-primary w-[70px] h-[30px] rounded-[3px]">
									<span>
										{{ t('detailData') }}
									</span>
							...
							<div class="statistic-footer flex justify-between items-end mt-[10px]">
								<div>
									<div class="footer-item text-[14px] text-[#666]">
										<span>{{ t('accumulateOrderNum') }}：</span>
										<span class="green ml-1">
											{{ statTotal.way_order_num }}
										</span>
									</div>
									<div class="footer-item text-[14px] text-[#666]">
										<span>{{ t('yesterdayOrderNum') }}：</span>
										<span class="green ml-1">
											+ {{ statYesterdayInfo.way_order_num }}
										</span>
										<span></span>
									</div>
								</div>
				...
				<div class="mt-[15px] flex">
					<el-card class="box-card !border-none flex-1 mr-[15px]" shadow="never">
						...
						<div class="h-[300px] relative">
							<div class="absolute top-0 right-0 z-[1]">
								<el-button size="small" @click="drawChart(statDayInfo.hotel_order_num)">{{ t('hotelData')
								}}</el-button>
								<el-button size="small" @click="drawChart(statDayInfo.scenic_order_num)">{{ t('scenicData')
								}}</el-button>
								<el-button size="small" @click="drawChart(statDayInfo.way_order_num)">{{ t('wayData')
								}}</el-button>
							</div>
					...
					<el-card class="box-card !border-none flex-1" shadow="never">
						...
						<div class="h-[300px] relative">
							<div class="absolute top-0 right-0 z-[1]">
								<el-button size="small" @click="drawChartTo(statHourInfo.hotel_order_money)">{{ t('hotelData')
								}}</el-button>
								<el-button size="small" @click="drawChartTo(statHourInfo.scenic_order_money)">{{
									t('scenicData') }}</el-button>
								<el-button size="small" @click="drawChartTo(statHourInfo.way_order_money)">{{ t('wayData')
								}}</el-button>
							</div>
		...
		<el-dialog v-model="showDialog" :title="title || t('verifyInfo')" width="500px" :destroy-on-close="true">
			...
			<el-form :model="formData" label-width="110px" ref="formRef" :rules="formRules" class="page-form"
				...
				<el-form-item :label="t('goodsImg')">
					<img :src="img(verifyInfo.goods_image)" />
				</el-form-item>
