        ...
        try {
            ...
            while (true) {
                ...
                foreach ($currentPageSites as $k => $v) {
                    ...
                    JtkOrder::dispatch(['site_id' => $v['site_id'], 'config' => $config, 'type' => 1]);
                    MyxqDcOrder::dispatch(['site_id' => $v['site_id'], 'config' => $config, 'type' => 1]);
                    MyxqMovieOrder::dispatch(['site_id' => $v['site_id'], 'config' => $config, 'type' => 1]);
                    MyxqOtherOrder::dispatch(['site_id' => $v['site_id'], 'config' => $config, 'type' => 1]);
                    MyxqNearOrder::dispatch(['site_id' => $v['site_id'], 'config' => $config, 'type' => 1]);
                    MyxqRechaegeOrder::dispatch(['site_id' => $v['site_id'], 'config' => $config, 'type' => 1]);
                }
