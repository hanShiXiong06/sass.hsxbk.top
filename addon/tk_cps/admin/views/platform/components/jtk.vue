  ...
  >
    ...
    >
      <div style="width: 640px" class="mb-2">
        <el-alert
          type="info"
          title="提示：请正确配置聚推客信息，并且启用该渠道，否则无法正常使用"
          :closable="false"
          show-icon
        />
      </div>
      ...
      <el-form-item label="聚推客pub_id" prop="pub_id">
        <el-input
          ...
          placeholder="请输入聚推客pub_id"
          class="input-width"
          show-word-limit
          clearable
        />
      </el-form-item>
      <el-form-item label="聚推客api_key" prop="api_key">
        <el-input
      ...
      <el-form-item label="快速导航">
        <el-button>
          <a href="https://pub.jutuike.com/index" target="_blank">开放平台</a>
        </el-button>
      </el-form-item>
    </el-form>
...
const formRules = computed(() => {
  return {
    ...
    pub_id: [{ required: true, message: "请输入pub_id", trigger: "blur" }],
  };
});
