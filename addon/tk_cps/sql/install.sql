...
) ENGINE = InnoDB AUTO_INCREMENT = 926 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'CPS活动链接' ROW_FORMAT = Dynamic;
...
(
    ...
    `create_time` int(13) NULL DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 336 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '活动详情' ROW_FORMAT = Dynamic;
