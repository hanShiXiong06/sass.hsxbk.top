<template>
    <div>
        <el-dialog v-model="showDialog" :title="t('serviceSpreadTitle')" width="500px" :destroy-on-close="true">
...
const show = (data: any) => {
    ...
    page.value = `/addon/vipcard/pages/service/detail?id=${service.goods_id}`
    loadQrcode()
