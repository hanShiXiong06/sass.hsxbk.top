  ...
  <div class="main-container">
    <el-card class="box-card !border-none" shadow="never">
      ...
      <template v-for="(item, index) in storageTableData.data">
        <component
          :is="item.component"
          :ref="(el) => setStorageTypeRefs(el, index)"
          v-if="item.component"
          @complete="loadStorageList()"
        />
      </template>
    </el-card>
  </div>
...
import { t } from "@/lang";
import { getStorageList } from "@/addon/manage_oss/api/manageoss";
