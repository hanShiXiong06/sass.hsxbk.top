            ...
            <template v-if="parentLinkName == 'DIY_LINK'">
              <div class="mb-[16px]">
                <el-form-item :label="t('diyLinkName')">
                  <el-input
                    v-model="selectLink.title"
                    :placeholder="t('diyLinkNamePlaceholder')"
                  />
                </el-form-item>
              </div>
              <div class="mb-[16px]">
                <el-form-item :label="t('diyLinkUrl')">
                  <el-input
                    v-model="selectLink.url"
                    :placeholder="t('diyLinkUrlPlaceholder')"
                  />
                </el-form-item>
              </div>
              <el-form-item label=" ">
                <div class="text-sm text-gray-400 select-text">
                  路径必须以“/”开头，例：/app/pages/index/index
                </div>
              </el-form-item>
              <el-form-item label=" ">
                <div class="text-sm text-gray-400 select-text">
                  跳转外部链接“http”或“https”开头，例：https://baidu.com
                </div>
              </el-form-item>
            </template>
            <template v-if="parentLinkName == 'DIY_JUMP_OTHER_APPLET'">
              <div class="mb-[16px]">
                <el-form-item :label="t('diyAppletId')">
                  <el-input
                    v-model="selectLink.appid"
                    :placeholder="t('diyAppletIdPlaceholder')"
                    clearable
                    maxlength="50"
                  />
                </el-form-item>
              ...
              <div class="mb-[16px]">
                <el-form-item :label="t('diyAppletPage')">
                  <el-input
                    v-model="selectLink.page"
                    :placeholder="t('diyAppletPagePlaceholder')"
                    clearable
                    maxlength="50"
                  />
                </el-form-item>
              ...
              <el-form-item label=" ">
                <div class="text-sm text-gray-400 select-text">
                  小程序路径格式如：app/pages/index/index
                </div>
              </el-form-item>
            </template>
            <template v-if="parentLinkName == 'DIY_MAKE_PHONE_CALL'">
              <div class="mb-[16px]">
                <el-form-item :label="t('diyMakePhone')">
                  <el-input
                    v-model="selectLink.mobile"
                    :placeholder="t('diyMakePhonePlaceholder')"
                    clearable
                    maxlength="50"
                  />
                </el-form-item>
