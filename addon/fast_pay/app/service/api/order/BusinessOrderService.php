...
class BusinessOrderService extends BaseApiService
{

    public function __construct()
    {
        parent::__construct();
        $this->orderModel = new BusinessOrder();
    }
    ...
    public function create($data)
    {
        ...
        try {
            ...
            //添加订单支付表
            (new CorePayService())->create($this->site_id, PayDict::MEMBER, $this->member_id, $res['order_money'], OrderDict::getBusinessOrderType()['type'], $res['id'], OrderDict::getBusinessOrderType()['name']);
            Db::commit();
            return [
                'trade_type' => OrderDict::getBusinessOrderType()['type'],
                'trade_id' => $res['id']
            ];
        } catch (Exception $e) {
            Db::rollback();
