...
namespace addon\fast_pay\app\service\api\pay;

use addon\fast_pay\app\service\core\businesspay\CorePayService;
 ...
 * 支付业务
 */
class BusinessPayService extends BaseApiService
{
     ...
     */
    public function pay(string $type, string $trade_type, int $trade_id, string $return_url = '', string $quit_url = '', string $buyer_id = '', string $voucher = '', string $openid = '',string $business_id='')
    {
        ...
        return $this->core_pay_service->pay($this->site_id, $trade_type, $trade_id, $type, $this->channel, $openid, $return_url, $quit_url, $buyer_id, $voucher,$business_id);
    }
    ...
    public function getInfoByTrade($trade_type, $trade_id){
