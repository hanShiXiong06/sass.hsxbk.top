...
class ShopGiftcardOrderCalculate
{
    public function handle(array $params)
    {
        ...
        if (!empty($order_obj->extend_data) && $order_obj->extend_data[ 'activity_type' ] == ActiveDict::GIFTCARD && $sku_info && $sku_data) {
            $data = [
            ...
            if ($res) {
                ...
                return [
                    ...
                    'relate_id' => $order_obj->extend_data[ 'relate_id' ],
                    'activity_type' => ActiveDict::GIFTCARD
                ];
            }
        }
    }
