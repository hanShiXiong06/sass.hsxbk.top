<template>
    <div>
        <el-dialog v-model="showDialog" :title="t('giftcardSpreadTitle')" width="500px" :destroy-on-close="true">
...
const show = (data: any) => {
    ...
    page.value = `/addon/shop_giftcard/pages/detail?giftcard_id=${giftcard.giftcard_id}`
