 ...
 * 分销订单服务层
 */
class AgentOrderService extends BaseAdminService
{
    ...
    {
        $field = 'id,order_id,order_no,site_id,commission_agent,fenxiao_member_id1,fenxiao_member_id2,agent_members,create_time';
        ...
        $search_model = $this->model
            ...
            ->with([
                ...
                'fenxiao_order_goods' => function ($query) {
                    ...
                    )->where([['commission_type', '=', FenxiaoSettlementDict::AGENT]]);
                },
