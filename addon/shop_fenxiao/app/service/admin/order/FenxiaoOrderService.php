 ...
 * 分销订单服务层
 */
class FenxiaoOrderService extends BaseAdminService
{
    ...
    {
        $field = 'id,order_id,order_no,site_id,commission_fenxiao,fenxiao_member_id1,fenxiao_member_id2, create_time';
        ...
        $search_model = $this->model
            ...
            ->with([
                ...
                'fenxiao_order_goods' => function ($query) {
                    ...
                    )->where([['commission_type', '=', FenxiaoSettlementDict::FENXIAO]])->append(['calculate_type_name']);
                },
