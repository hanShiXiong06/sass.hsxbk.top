 ...
 * 团队订单服务层
 */
class TeamOrderService extends BaseApiService
{
    ...
    {
        $fenxiao_info = (new Fenxiao())->where([['site_id', '=', $this->site_id], ['member_id', '=', $this->member_id]])->field("team_commission")->findOrEmpty()->toArray();
        $unsettlement_commission = $this->model->where([['fenxiao_member_id', '=', $this->member_id], ['is_refund', '=', 0], ['is_settlement', '=', 0], ['commission_type', '=', 'team']])->sum("commission");
        return [
            'team_commission' => format_float_money($fenxiao_info['team_commission']) ?? 0.00,
