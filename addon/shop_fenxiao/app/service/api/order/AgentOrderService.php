 ...
 * 代理订单服务层
 */
class AgentOrderService extends BaseApiService
{
    ...
    {
        $fenxiao_info = (new Fenxiao())->where([['site_id', '=', $this->site_id], ['member_id', '=', $this->member_id]])->field("agent_commission")->findOrEmpty()->toArray();
        $unsettlement_commission = $this->model->where([['fenxiao_member_id', '=', $this->member_id], ['is_refund', '=', 0], ['is_settlement', '=', 0], ['commission_type', '=', 'agent']])->sum("commission");
        return [
            'agent_commission' => format_float_money($fenxiao_info['agent_commission']) ?? 0.00,
