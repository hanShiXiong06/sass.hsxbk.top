            ...
            <el-form class="page-form" :model="formData" label-width="120px" ref="taskFormRef" :rules="formRules">
                        ...
                        <div class="flex flex-col mt-[10px]">
                            <el-radio label="order_num" class="!h-[auto] !flex !items-start">
                                <div class="flex -mt-[9px]">
                                    ...
                                    <div class="flex items-center ml-[2px] text-[#666]">
                                        <el-input v-model="formData.rules[0].condition.order_num" clearable @keyup="filterNumber($event)" class="!w-[100px] ml-2" maxlength="7" show-word-limit :disabled="formData.rules[0].condition.type.indexOf('order_num') == -1" />
                            ...
                            <el-radio label="order_money" class="my-[15px] !h-[auto] !flex !items-start">
                                <div class="flex -mt-[9px]">
                                    ...
                                    <div class="flex items-center ml-[2px] text-[#666]">
                                        <el-input v-model="formData.rules[0].condition.order_money" maxlength="7" @keyup="filterDigit($event)" show-word-limit clearable class="!w-[100px] ml-2" :disabled="formData.rules[0].condition.type.indexOf('order_money') == -1" />
                            ...
                            <el-radio label="child_num" class="!h-[auto] !flex !items-start">
                                <div class="flex -mt-[9px]">
                                    ...
                                    <div class="flex items-center ml-[2px] text-[#666]">
                                        <el-input v-model="formData.rules[0].condition.child_num"  maxlength="7" @keyup="filterNumber($event)" show-word-limit clearable class="!w-[100px] ml-2" :disabled="formData.rules[0].condition.type.indexOf('child_num') == -1" />
                ...
                <el-form-item :label="t('taskContent')" prop="rules[0].reward.commission">
                    <div class="flex items-center">
                        ...
                        <el-input v-model="formData.rules[0].reward.commission" clearable @keyup="filterDigit($event)" class="!w-[200px]" maxlength="7" show-word-limit />
                ...
                <el-form-item :label="t('remark')">
                    <el-input v-model="formData.remark" maxlength="200" show-word-limit type="textarea" clearable :placeholder="t('remarkPlaceholder')" class="!w-[450px]" rows="6"/>
                </el-form-item>
            </el-form>
        </el-card>
