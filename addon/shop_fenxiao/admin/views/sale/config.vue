                ...
                <el-card class="card !border-none" shadow="never">
                    ...
                    <el-form-item :label="t('salePeriod')" prop="period">
                        <div v-if="config.period_type == 'month'" class="flex flex-col">
                            <div>
                                <el-input class="!w-[214px]" v-model="config.period" :placeholder="t('monthDatePlaceholder')" @keyup="filterNumber($event)" maxlength="2" />
                            ...
                            <el-checkbox label="order_money" class="!h-[auto] !flex !items-center">
                                <div class="flex items-center">
                                    ...
                                    <div class="flex items-center ml-[10px] text-[#666]"  v-if="conditionAssistObj.type.indexOf('order_money') > -1">
                                        <el-input v-model="conditionAssistObj.content.order_money" clearable class="!w-[100px]" maxlength="60" @keyup="filterDigit($event)" />
                                ...
                                <div class="flex flex-col w-[500px] mb-[10px]" v-if="config.reward[index]">
                                    ...
                                    <div class="flex items-center pl-[30px]">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <el-input v-model="config.reward[index].end" clearable class="!w-[100px] mx-[8px]" @keyup="filterNumber($event)" @change="rewardEndChange(index,$event)" />
                                    ...
                                    <div class="flex items-center mt-[10px] pl-[30px]">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <el-input v-model="config.reward[index].reward.commission" clearable @change="rewardCommissionChange(index,$event)" class="!w-[100px] mx-[8px]" @keyup="filterDigit($event)" />
