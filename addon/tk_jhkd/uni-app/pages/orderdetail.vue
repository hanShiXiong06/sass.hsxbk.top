<template>
	<view class="">
		<view class="tk-card">
			...
			<view class="detail-tag mt-2 text-xs font-weight p-4 text-[#878787]" v-if="form.orderInfo">
				物品:{{form.orderInfo.goods}}重量:{{form.orderInfo.weight}}kg {{form.orderInfo.goods}}
