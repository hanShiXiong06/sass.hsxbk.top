...
namespace addon\spdr\app\adminapi\controller\spdrlist;

use core\base\BaseAdminController;
use addon\spdr\app\service\admin\spdrlist\SpdrListService;
...
class SpdrList extends BaseAdminController
{
    ...
    */
    ...
    public function add(){
        ...
        $this->validate($data, 'addon\spdr\app\validate\spdrlist\SpdrList.add');
    ...
    public function edit(int $id){
        ...
        $this->validate($data, 'addon\spdr\app\validate\spdrlist\SpdrList.edit');
