...
import {
  ...
  importGoods,
  importGoodsAdmin,
} from "@/addon/spdr/api/goods";
import { ElMessage } from "element-plus";
import { img } from "@/utils/common";
import uploadXlsx from "@/addon/spdr/views/upload-xlsx/index.vue"
...
const downFile = () => {
  ...
  link.href = img("addon/spdr/file/goods.xlsx");
  link.target = "_blank";
    ...
    if (valid) {
      ...
      importGoods(data)
        .then((res) => {
          ...
          // const url = "/shop/goods/list";
          // router.push(url);
        })
        .catch(() => {
          loading.value = false;
          router.push("/spdr/shop/goods/import_do");
