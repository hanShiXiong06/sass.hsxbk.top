  ...
  <div class="main-container">
    <el-card class="box-card !border-none" shadow="never">
      ...
      >
        <el-form
          :inline="true"
          :model="spdrListTable.searchParam"
          ref="searchFormRef"
        >
          ...
          <el-form-item :label="t('createTime')" prop="create_time">
            <el-date-picker
              v-model="spdrListTable.searchParam.create_time"
              type="datetimerange"
      ...
      <div class="mt-[10px]">
        <el-table
          :data="spdrListTable.data"
          size="large"
          v-loading="spdrListTable.loading"
        >
          <template #empty>
        ...
        <div class="mt-[16px] flex justify-end">
          <el-pagination
            v-model:current-page="spdrListTable.page"
            v-model:page-size="spdrListTable.limit"
            layout="total, sizes, prev, pager, next, jumper"
            :total="spdrListTable.total"
            @size-change="loadSpdrListList()"
            @current-change="loadSpdrListList"
          />
        </div>
      </div>
...
import { getSpdrListList, deleteSpdrList } from "@/addon/spdr/api/spdrlist";
import { img } from "@/utils/common";
import { ElMessageBox, FormInstance } from "element-plus";
import Edit from "@/addon/spdr/views/spdrlist/components/spdrlist-edit.vue";
