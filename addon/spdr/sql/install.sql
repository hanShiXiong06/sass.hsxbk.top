...
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}spdr_list`;
CREATE TABLE `{{prefix}}spdr_list`
(
...
) ENGINE = InnoDB AUTO_INCREMENT = 86 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品导入列表' ROW_FORMAT = Dynamic;
