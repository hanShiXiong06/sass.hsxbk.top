...
namespace addon\hsx_yinsheng_pay\app\dict\pay;
...
class PayDict
{
    ...
    public const YINSHENGPAY = 'yinshengpay';//银盛聚合支付
    ...
    public const YINSHENG_ICON = self::PAY_ICON_PATH . 'wechatpay.png';//银盛聚合支付
    ...
    public static function getPayType(array $types = [])
    {
        $list = [
            ...
            self::YINSHENGPAY => [
                'name' => '银盛聚合支付',
                'key' => self::YINSHENGPAY,
                'icon' => self::YINSHENGPAY_ICON,
                'setting_component' => ''
            ],//银盛聚合支付
        ];
