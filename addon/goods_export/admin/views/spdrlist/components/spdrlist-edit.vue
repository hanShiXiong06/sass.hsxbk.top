<template>
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateSpdrList') : t('addSpdrList')" width="50%"
        ...
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form"
            ...
            <el-form-item :label="t('catId')">
                <el-input v-model="formData.cat_id" clearable :placeholder="t('catIdPlaceholder')"
                    class="input-width" />
            </el-form-item>

            <el-form-item :label="t('catName')">
                <el-input v-model="formData.cat_name" clearable :placeholder="t('catNamePlaceholder')"
                    class="input-width" />
            </el-form-item>
            ...
            <el-form-item :label="t('successNum')">
                <el-input v-model="formData.success_num" clearable :placeholder="t('successNumPlaceholder')"
                    class="input-width" />
            </el-form-item>

            <el-form-item :label="t('failNum')">
                <el-input v-model="formData.fail_num" clearable :placeholder="t('failNumPlaceholder')"
                    class="input-width" />
            </el-form-item>
...
import { addSpdrList, editSpdrList, getSpdrListInfo } from '@/addon/goods_export/api/spdrlist'
