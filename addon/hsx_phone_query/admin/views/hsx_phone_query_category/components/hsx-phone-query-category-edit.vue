<template>
    <el-dialog v-model="showDialog" :title="formData.site_id ? t('updateHsxPhoneQueryCategory') : t('addHsxPhoneQueryCategory')" width="50%" class="diy-dialog-wrap"
        :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form" v-loading="loading">
                <el-form-item :label="t('typeId')" prop="type_id">
                    <el-select class="input-width"  v-model="formData.type_id" clearable :placeholder="t('typeIdPlaceholder')">
